-- Recreate users table and related tables for Cloudflare D1
-- Run this with: wrangler d1 execute <DATABASE_NAME> --file=./src/recreate_tables.sql
...
INSERT OR IGNORE INTO users (
    ...
    'admin@concordia.ca',
    '514-848-2424',
    '$2b$10$rKUOKLqfWdqE.yT8y3O.KuEVrPqhDKZQqCY3qQjZhKQXoYqoJ5T.6',
    'admin',
    1,
    CURRENT_TIMESTAMP
);
...
INSERT OR IGNORE INTO users (
    ...
    'staff@concordia.ca',
    '514-848-2425',
    '$2b$10$yT8y3O.KuEVrPqhDKZQqCY3qQjZhKQXoYqoJ5T.6rKUOKLqfWdqE.',
    'staff',
    1,
    CURRENT_TIMESTAMP
);