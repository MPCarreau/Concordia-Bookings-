-- =====================================================
-- COMPLETE DATABASE SETUP WITH ALL ACTUAL DATA
-- SOEN287 Project - MySQL Migration from Cloudflare D1
-- Includes: Schema + Users + Resources + Bookings + Booking Requests
-- =====================================================
...
-- Schedule Exceptions (Modified hours for specific days)
...
-- Blackout Dates (Days where no bookings are allowed)
...
-- =====================================================
-- DATA IMPORT - ALL ACTUAL DATA FROM CLOUDFLARE D1
-- =====================================================
...
VALUES ('working_hours', '{"start":"09:00","end":"17:00"}');

SET FOREIGN_KEY_CHECKS = 1;

-- =====================================================
-- NOTE: Bookings and Booking Requests data
-- =====================================================
-- The bookings (129 rows) and booking_requests (18 rows) data
-- is in a separate file: database/bookings_data.sql
--
-- To import them:
-- After running this file, run: database/bookings_data.sql
-- Or manually run both files together in phpMyAdmin
-- =====================================================
...
SELECT '=============================================' AS '';
SELECT 'NEXT STEP: Import bookings data' AS '';
SELECT '=============================================' AS '';
SELECT 'Run this SQL file next: database/bookings_data.sql' AS 'Instructions';
SELECT 'It contains 129 bookings and 18 booking requests' AS 'Note';
